        ...
        <div className="flex gap-2 items-center">
            <div className="h-full flex justify-center items-center">
                <div className={`avatar ${isOnline ? "online" : ""}`}>
                    <div className="w-12 rounded-full">
                        <img src={'https://fastly.picsum.photos/id/631/200/300.jpg?hmac=fgDzRjKee8EpUbckbz7kp1S1ssIqedrw2oOk5mBYQvk'} alt="user avatar" />
                    </div>
                </div>
            </div>
            ...
            <div class="font-bold text-black text-base overflow-hidden text-ellipsis whitespace-nowrap max-w-[18ch]">
                ...
                <div className="flex justify-between">
                    <button class="w-[45%] py-[2px] text-center  bg-sky-500 rounded-lg text-lg font-semibold text-white">Add Friend</button>
